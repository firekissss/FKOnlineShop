...
# ─────────────────────────────────────────────────────────────"""
    ...
    print("\nВывод суммы смартфонов 1 и 2:")
    smartphone_sum = smartphone1 + smartphone2
    print(smartphone_sum)

    print("\nВывод суммы газонных трав 1 и 2:")
    grass_sum = grass1 + grass2
    print(grass_sum)

    print("\nПроверка ошибки при сложении смартофона и травы:")
    try:
    ...
    print('\nВывод продуктов из категории "Смартфоны"')
    print(category_smartphones.products)
    print('\nВывод продуктов из категории "Газонная трава"')
    print(category_grass.products)
    print("\nКоличество продуктов (все, и трава и мобильники):")
    print(Category.product_count)

    print("\nПроверка ошибки при добавлении чего-то, кроме продукта:")
    try:
